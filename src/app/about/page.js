    ...
    <>
      ...
      <section className="py-24 sm:py-32">
        <Shell>
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
            <Reveal>
              ...
              <div className="mt-6 space-y-5 leading-relaxed text-silver">
                <p>
                  Fayanex was founded to close a gap in Indian manufacturing:
                  the machinery behind technical textiles has stayed mechanical
                  and fragmented while the rest of industry moved toward
                  intelligent, connected systems.
                </p>
                <p>
                  We&rsquo;re a small, technical team working at the intersection
                  of mechanical engineering, materials and automation &mdash;
                  designing a machine that owns the full path from polymer to
                  finished woven bag.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.12}>
              ...
              <div className="mt-6 space-y-5 leading-relaxed text-silver">
                <p>
                  We believe the next leap in woven-bag production isn&rsquo;t a
                  faster line &mdash; it&rsquo;s a smarter, self-contained
                  machine that removes the seams between stages entirely.
                </p>
                <p>
                  Our long-term aim is to make that capability and to set a new
                  reference point for what a single piece of technical-textile
                  machinery can do.
                </p>
              </div>
            </Reveal>
          ...
          <div className="mt-24">
            <Reveal>
              <SteelHeading className="text-3xl sm:text-4xl">
                What sets us apart
              </SteelHeading>
            </Reveal>
              ...
              {distinctions.map((d, i) => (
                <Reveal key={d.t} delay={i * 0.08}>
                  <div className="panel h-full border-0 bg-void p-8">
                    ...
                    <h3 className="mt-6 font-display text-lg font-medium text-chrome">
                      {d.t}
                    </h3>
